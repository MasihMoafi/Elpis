...
function renderLedger(){
 ...
 const names={systemInstructions:'System instructions',developerMessages:'Developer instructions',userMessages:'User messages',agentMessages:'Assistant messages',reasoning:'Reasoning + compaction (estimated)',toolCalls:'Tool calls',toolResults:'Tool results',toolDefinitions:'Tool definitions',outputSchema:'Output schema',unrecognizedItems:'Other items',estimatedTotal:'Estimated total'};
