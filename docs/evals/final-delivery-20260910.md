...
- Removed the equalizer beside “Elpising” and obsolete text-dissolve code. Elpis
  uses a white text shimmer; permission and active Read/Search/Run labels animate
...
`9ba88b9935b9eb61ce4f9daaa80a49efb2837780687af8d7517f48b12b74aebb`.
...
3. Type and drag-select during replies. Check the red caret artifact, white Elpis
   shimmer, animated permission/tool labels, and absence of the old equalizer.
